        ...
        <div class="align-items-center d-flex h-100">
            <div class="card-body">
                ...
                <div class="logout-icon m-auto">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 161.2 161.2" enable-background="new 0 0 161.2 161.2" xmlSpace="preserve">
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Back to <span onClick={()=>_history.push("/")} class="text-muted ms-1 p-cursor"><b>Log In</b></span></p>
                </footer>
